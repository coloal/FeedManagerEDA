 ...
 * @author alberto
 */
public class SourceRedisSinkConnector extends SinkConnector{
    private static Logger logger = LoggerFactory
            .getLogger(SourceRedisSinkConnector.class);
    
    private SourceRedisSinkConnectorConfig config_;
    ...
    public void start(Map<String, String> props) {
        ...
        this.config_ = new SourceRedisSinkConnectorConfig(props);
    ...
    public Class<? extends Task> taskClass() {
        return SourceRedisSinkTask.class;
    }
    ...
    public ConfigDef config() {
        return SourceRedisSinkConnectorConfig.configDef();
    }
    
    public SourceRedisSinkConnectorConfig getConfig() {
        return config_;
    }
